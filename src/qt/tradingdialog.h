...
private slots:
    ...
    QString BuyMEDIC(QString OrderType, double Quantity, double Rate);
    QString SellMEDIC(QString OrderType, double Quantity, double Rate);
